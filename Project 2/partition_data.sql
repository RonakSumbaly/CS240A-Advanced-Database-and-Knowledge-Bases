...
CREATE TABLE TEST_DATASET("PID" INTEGER, "COLUMNNO" INTEGER, "ATT" VARCHAR(10),"DECISION" VARCHAR(10), "WEIGHT" INTEGER)~
CREATE TABLE TRAIN_DATASET("PID" INTEGER, "COLUMNNO" INTEGER, "ATT" VARCHAR(10),"DECISION" VARCHAR(10), "WEIGHT" INTEGER)~
